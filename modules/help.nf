...
def printHelp() {
  log.info"""
  Usage:
    nextflow run connor-lab/ncov2019-artic-nf -profile (mamba,conda,singularity,docker,slurm,lsf) ( --illumina | --nanpolish | --medaka ) --prefix [prefix] [workflow-options]
  ...
  Illumina workflow options:
    ...
    Optional:
      ...
      --schemeVersion         ARTIC scheme version (Default: 'V4')
      --schemeRepoURL         Repo to download your primer scheme from (Default: 'https://github.com/artic-network/artic-ncov2019')
                              If a local clone of a scheme repo is preferred it should be set with file:///path/to/own/clone/of/github.com/artic-network/artic-ncov2019
      --schemeDir             Directory within schemeRepoURL that contains primer schemes (Default: 'primer_schemes')
